...
function normalizeLayout(value: unknown): AdventureMapChapterLayout | null {
  if (!value || typeof value !== "object") return null;
...
function renderAdventureMapLayout(layouts: Record<number, AdventureMapChapterLayout>) {

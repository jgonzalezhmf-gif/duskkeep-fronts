...
export const AUDIO_MUSIC_ASSETS: AudioAssetManifest<AudioMusicAssetName> = {
  ...
  intro: { src: "/assets/audio/music/intro_cinematic.mp3?v=20260517-intro-cinematic", credit: "elevenlabs", loop: false, gain: 0.78 },
  intro_cinematic: { src: "/assets/audio/music/intro_cinematic.mp3?v=20260517-intro-cinematic", credit: "elevenlabs", loop: false, gain: 0.78 },

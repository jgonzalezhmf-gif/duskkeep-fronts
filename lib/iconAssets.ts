...
export const GAME_ICON_ASSET_MANIFEST = {
  ...
  combat: {
    core: `${COMBAT_ROOT}/core.webp`,
    breach: `${COMBAT_ROOT}/breach.webp`,
    clash: `${COMBAT_ROOT}/clash.webp`,
    move: `${COMBAT_ROOT}/move.webp`,
    attack: `${COMBAT_ROOT}/attack.webp`,
    shield: `${COMBAT_ROOT}/shield.webp`,
    heal: `${COMBAT_ROOT}/heal.webp`,
    skill: `${COMBAT_ROOT}/skill.webp`,
    stun: `${COMBAT_ROOT}/stun.webp`,
    summon: `${COMBAT_ROOT}/summon.webp`,
    target: `${COMBAT_ROOT}/target.webp`,
    leader_power: `${COMBAT_ROOT}/leader_power.webp`,
    danger: `${COMBAT_ROOT}/danger.webp`,
    advantage: `${COMBAT_ROOT}/advantage.webp`,
  },
  cards: {
  ...
  progression: {
    upgrade: `${PROGRESSION_ROOT}/upgrade.webp`,
    evolve: `${PROGRESSION_ROOT}/evolve.webp`,
    star: `${PROGRESSION_ROOT}/star.webp`,
    unlock: `${PROGRESSION_ROOT}/unlock.webp`,
    claim: `${PROGRESSION_ROOT}/claim.webp`,
    level_up: `${PROGRESSION_ROOT}/level_up.webp`,
    tier_up: `${PROGRESSION_ROOT}/tier_up.webp`,
    reward_chest: `${PROGRESSION_ROOT}/reward_chest.webp`,
  },
  status: {

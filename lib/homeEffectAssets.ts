...
export const HOME_EFFECT_ASSETS: Partial<Record<HomeEffectId, HomeEffectAsset>> = {
  flame_loop: {
    src: "/assets/home/effects/flame_loop.webp",
    expectedFile: "flame_loop.webp",
    frameCount: 6,
    compatibilitySrcs: [
  ...
  flag_red_loop: {
    src: "/assets/home/effects/flag_red_cloth_loop.webp",
    expectedFile: "flag_red_cloth_loop.webp",
    frameCount: 5,
    staticSrc: "/assets/home/effects/flag_red_pole.webp",
    animatedSrc: "/assets/home/effects/flag_red_cloth_loop.webp",
    anchor: { name: "pole-bottom", xPercent: 50, yPercent: 100 },
    renderMode: "animated",
    pipelineNote: "Layered pole + cloth loop. Keeps pole visually stable.",
  },
  portal_blue_loop: {
    src: "/assets/home/effects/portal_blue_loop.webp",
    expectedFile: "portal_blue_loop.webp",
    frameCount: 6,
    anchor: { name: "center", xPercent: 50, yPercent: 50 },
    renderMode: "animated",
  },
  crystal_purple_loop: {
    src: "/assets/home/effects/crystal_purple_loop.webp",
    expectedFile: "crystal_purple_loop.webp",
    frameCount: 6,
    anchor: { name: "bottom-center", xPercent: 50, yPercent: 100 },
    renderMode: "animated",
  },
  blue_flame_loop: {
    src: "/assets/home/effects/blue_flame_loop_aligned.webp",
    expectedFile: "blue_flame_loop_aligned.webp",
    frameCount: 6,
    animatedSrc: "/assets/home/effects/blue_flame_loop_aligned.webp",
    anchor: { name: "bottom-center", xPercent: 50, yPercent: 100 },
    renderMode: "animated",
    pipelineNote: "Uses a normalized spritesheet.",
  },
  purple_flame_loop: {
    src: "/assets/home/effects/purple_flame_loop_base_aligned.webp",
    expectedFile: "purple_flame_loop_base_aligned.webp",
    frameCount: 6,
    animatedSrc: "/assets/home/effects/purple_flame_loop_base_aligned.webp",
    anchor: { name: "bottom-center", xPercent: 50, yPercent: 100 },
    renderMode: "animated",
    pipelineNote: "Uses a normalized spritesheet.",
  },
  lantern_warm_loop: {
    src: "/assets/home/effects/lantern_warm_loop.webp",
    expectedFile: "lantern_warm_loop.webp",
    frameCount: 6,
    anchor: { name: "center", xPercent: 50, yPercent: 50 },
  ...
  candle_loop: {
    src: "/assets/home/effects/candle_loop.webp",
    expectedFile: "candle_loop.webp",
    frameCount: 6,
    anchor: { name: "bottom-center", xPercent: 50, yPercent: 100 },
    renderMode: "staticWithLocalAnimation",

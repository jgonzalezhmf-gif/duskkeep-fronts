...
export const HOME_LANDMARK_ASSETS: Partial<Record<HomeLandmarkId, HomeLandmarkAsset>> = {
  fortress: {
    src: "/assets/home/landmarks/fortress.webp",
    ...
    expectedFile: "fortress.webp",
    expectedWebpFile: "fortress.webp",
  },
  adventure: {
    src: "/assets/home/landmarks/adventure_gate.webp",
    ...
    sizes: "(max-width: 768px) 34vw, 280px",
    expectedFile: "adventure_gate.webp",
    expectedWebpFile: "adventure_gate.webp",
  },
  arena: {
    src: "/assets/home/landmarks/arena.webp",
    ...
    sizes: "(max-width: 768px) 34vw, 280px",
    expectedFile: "arena.webp",
    expectedWebpFile: "arena.webp",
  },
  market: {
    src: "/assets/home/landmarks/market.webp",
    ...
    sizes: "(max-width: 768px) 34vw, 280px",
    expectedFile: "market.webp",
    expectedWebpFile: "market.webp",
  },
  events: {
    src: "/assets/home/landmarks/events_shrine.webp",
    ...
    sizes: "(max-width: 768px) 34vw, 280px",
    expectedFile: "events_shrine.webp",
    expectedWebpFile: "events_shrine.webp",
  },
  deck: {
    src: "/assets/home/landmarks/deck_hall_clean.webp",
    ...
    sizes: "(max-width: 768px) 34vw, 280px",
    expectedFile: "deck_hall_clean.webp",
...
export const HOME_BACKGROUND_ASSETS: Partial<Record<HomeBackgroundId, HomeLandmarkAsset>> = {
  world_base: {
    src: "/assets/home/home_world_base.webp",
    ...
    expectedFile: "home_world_base.webp",

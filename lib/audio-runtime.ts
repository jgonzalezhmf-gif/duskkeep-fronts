...
export const THEME_MIX: Record<AudioThemeName, ThemeMixProfile> = {
  ...
  ladder: { fadeIn: 0.7, fadeOut: 0.68, preRoll: 0.05, dryLevel: 1, fxLevel: 0.44 },
  arena_trials: { fadeIn: 0.62, fadeOut: 0.7, preRoll: 0.05, dryLevel: 1, fxLevel: 0.48 },
  fortress_defense: { fadeIn: 0.62, fadeOut: 0.72, preRoll: 0.05, dryLevel: 1, fxLevel: 0.48 },

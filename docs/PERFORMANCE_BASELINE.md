...
Estas laminas ya estaban cubiertas por `.gitignore` y no aparecian referenciadas por manifests o componentes. Los assets recortados/registrados siguen dentro del proyecto.

...
- `.next/server/app`: 245 archivos, 1.01 MB.
- Chunk estatico mayor: CSS de 340.6 KB.
- Rutas HTML mas pesadas: `arena.html` 89.9 KB, `team.html` 84.3 KB, `adventure.html` 83.7 KB, `fortress.html` 66.6 KB.

...
- `.next/server/app`: 245 archivos, 1.14 MB.
- Chunk estatico mayor: CSS de 339.6 KB.
- Rutas HTML mas pesadas: `roster.html` 94.0 KB, `missions.html` 92.3 KB, `arena.html` 89.9 KB, `team.html` 84.3 KB.

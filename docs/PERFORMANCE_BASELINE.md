...
- `.next/server/app`: 245 archivos, 1.08 MB.
- Chunk estatico mayor: CSS de 340.1 KB.
- Rutas HTML mas pesadas: `missions.html` 92.3 KB, `arena.html` 89.9 KB, `team.html` 84.3 KB, `adventure.html` 83.7 KB.

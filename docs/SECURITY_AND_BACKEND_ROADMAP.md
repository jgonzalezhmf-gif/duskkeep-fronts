...
1. Validacion server-side de combate competitivo.
   ...
   - Estado MVP actual: ya existe una capa defensiva que valida coherencia `winner`/core HP/turnos antes de persistir `battle_results`, y los clientes Frontline generan un summary canonico versionado con seed/lane/events/actionLog. Todavia no reproduce el combate completo.

...
function SceneSky({ scene }: { scene: ScreenScene }) {
...
function SceneAtmosphere({ scene }: { scene: ScreenScene }) {
  const accent =
    scene === "shop"
...
function ParticleField({ scene }: { scene: ScreenScene }) {
  const tone =
    scene === "shop"
...
function ConstellationDust({ scene }: { scene: ScreenScene }) {
  const points =
    scene === "missions"
      ? [
          ["18%", "28%"],
...
function ForegroundSet({ scene }: { scene: ScreenScene }) {

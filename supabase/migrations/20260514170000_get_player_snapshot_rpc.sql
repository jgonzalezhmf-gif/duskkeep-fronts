-- Duskkeep Fronts - snapshot seguro de jugador.
-- Lectura server-side normalizada del estado persistido para usuarios
-- anonimos o vinculados. No realiza mutaciones.

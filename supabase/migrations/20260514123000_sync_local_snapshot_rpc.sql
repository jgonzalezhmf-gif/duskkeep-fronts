-- Duskkeep Fronts - importacion MVP de progreso local a cuenta autenticada.
-- Importa solo campos conocidos, aplica limites conservadores y no reduce
-- progreso online existente. No debe usarse para economia monetizada final.
